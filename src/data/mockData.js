...
export const DEMO_CARDS = {
  demo: {
    ...
    accent: '#2E6BE6',
    links: [
      { id: 'l1', platform: 'linkedin', url: 'https://linkedin.com/in/johndoe' },
      { id: 'l2', platform: 'dribbble', url: 'https://dribbble.com/johndoe' },
      { id: 'l3', platform: 'behance', url: 'https://behance.net/johndoe' },
      { id: 'l4', platform: 'instagram', url: 'https://instagram.com/johndoe.design' },
      { id: 'l5', platform: 'upwork', url: 'https://upwork.com/freelancers/~johndoe' },
    ],
